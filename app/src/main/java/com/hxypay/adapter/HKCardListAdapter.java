...
public class HKCardListAdapter extends BaseAdapter {

    private List<CreditRes.Info1> list;
    private Context context;

    public HKCardListAdapter(Context context, List<CreditRes.Info1> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.activity_hk_cardlist_item, null);
