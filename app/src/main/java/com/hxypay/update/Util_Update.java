...
public class Util_Update {
     ...
     * default one is {@link com.liulishuo.okdownload.core.Util.EmptyLogger}.
     *
     * @param l if provide logger is {@code null} we will using {@link Log} as default.
     */
    public static void setLogger(@Nullable com.liulishuo.okdownload.core.Util.Logger l) {
        logger = l;
    }
    ...
    public static @NonNull DownloadStore createRemitDatabase(@NonNull DownloadStore originStore) {
        ...
        com.liulishuo.okdownload.core.Util.d("Util_Update", "Get final download store is " + finalStore);
        return finalStore;
    }
    ...
    public static long parseContentLength(@Nullable String contentLength) {
        ...
        try {
            ...
            com.liulishuo.okdownload.core.Util.d("Util_Update", "parseContentLength failed parse for '" + contentLength + "'");
        }
    ...
    public static boolean isNetworkNotOnWifiType(ConnectivityManager manager) {
        if (manager == null) {
            com.liulishuo.okdownload.core.Util.w("Util_Update", "failed to get connectivity manager!");
            return true;
        }
    ...
    public static long parseContentLengthFromContentRange(@Nullable String contentRange) {
        ...
        try {
            ...
            com.liulishuo.okdownload.core.Util.w("Util_Update", "parse content-length from content-range failed " + e);
        }
        return CHUNKED_CONTENT_LENGTH;
    }
