...
public class HKPlainXEActivity extends BaseActivity {
    ...
    private String money, /*sTime,*/
            eTime, count, pc, province, city, mcc, mccCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hk_plain_xe);
        //请求下位置；
        App.getApp().getLocationClient().requestLocation();
//        Toast.makeText(context, MyLocationListener.getProvince()+MyLocationListener.getCity(), Toast.LENGTH_SHORT).show();
        initView();
        getMcc();
...
//                sTime = mStartTimeText.getText().toString();
