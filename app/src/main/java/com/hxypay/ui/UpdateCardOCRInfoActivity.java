...
public class UpdateCardOCRInfoActivity extends BaseActivity {
    ...
    private String idName, idNo, cardNo, bankUrl, tele, auth, payPwd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_card_ocr_info);
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_com:
                ...
                if (TextUtils.isEmpty(payPwd)) {
                    IToast.getIToast().showIToast("请输入支付密码");
                    return;
                }
                realName();
                break;
    ...
    private void realName() {
        ...
        OkHttpUtils.post()
                ...
                .params(Params.merRealNameAuthParams(tele, auth, idName, idNo, cardNo, bankUrl, "", "", payPwd, "2"))
            ...
            public void onResponse(PublicRes response, int id) {
                ...
                if (response != null) {
                    if (response.getCode().equals("0000")) {
                        IToast.getIToast().showIToast("更新成功");
