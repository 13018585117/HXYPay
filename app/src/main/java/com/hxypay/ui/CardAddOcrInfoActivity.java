...
public class CardAddOcrInfoActivity extends BaseActivity {
    ...
    private String idName, idNo, tele, cardNo, cvn, yxq, zdr, hkr, auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_card_add_ocr_info);
...
//                mTeleEt.requestFocus();
    ...
    private void addCard() {
        ...
        OkHttpUtils.post()
                ...
                .params(Params.addCardParams(cardNo, idName, cvn, yxq, tele, zdr, hkr, auth))
